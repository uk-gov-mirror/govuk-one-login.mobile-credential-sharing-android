 ...
 *
 * Maps [BarcodeScanResult] inputs to String? outputs.
 *
 * Expects two parameters for a test function:
 * - `result`: The [BarcodeScanResult] input.
 * - `expectedData`: The extracted QR value String? or null if not found.
 */
    ...
    override fun provideValues(context: Context?): List<TestParameters.TestParametersValues> =
        listOf(
            ...
            Triple(
                ...
                BarcodeScanResult.Single(urlQrCode(invalidBarcodeDataResultOne)),
